...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x02, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0x12, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0x22, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0x32, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0x42, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0x52, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0x62, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0x72, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0x92, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0xB2, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0xD2, NOP, 1, 0, AddressingMode::NoneAddressing),
        OpCode::new(0xF2, NOP, 1, 0, AddressingMode::NoneAddressing),
